pro alfven_stats_5_geteverything,filename=filename,energy_electrons=energy_electrons,energy_ions=energy_ions,analyse_noise=analyse_noise,$
...
;don't know how to go about it...
  ...
  for jjj=0,number_of_intervals-1 do begin
     ...
     curfile = as5_dir + 'batch_output--all_events/'+'Dartmouth_as5_dflux_all_'+strcompress(orbit_num,/remove_all)+'_'+strcompress(jjj,/remove_all)
     IF KEYWORD_SET(burst) THEN BEGIN
