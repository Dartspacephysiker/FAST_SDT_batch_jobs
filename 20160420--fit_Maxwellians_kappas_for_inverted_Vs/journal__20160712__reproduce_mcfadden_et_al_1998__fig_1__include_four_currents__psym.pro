...
PRO JOURNAL__20160712__REPRODUCE_MCFADDEN_ET_AL_1998__FIG_1__INCLUDE_FOUR_CURRENTS__PSYM,SAVE_PNG=save_png,SAVE_PS=save_ps, $
  ...
  R_B                            = 1e6 ;For calculating Maxwellian and Kappa current
  ...
  outSaveFile                    = GET_TODAY_STRING(/DO_YYYYMMDD_FMT) + '--McFadden_et_al_1998_Fig_1--four_currents.sav'
...
; OPTIONS,'ion_pa','ztitle','Log Eflux!C!CeV/cm!U2!N-s-sr-eV' ; z title
  ...
  kappa_current                  = DOUBLE(1.0e6) * KNIGHT_RELATION__DORS_KLETZING_11(Astruct.kappa,Astruct.temp,Astruct.N, $
                                                                    chartot_kappa_interp/DOUBLE(1.6e-19),R_B) ;, $
  ;; IN_POTBAR=in_potBar, $
  ;; OUT_POTBAR=potBar)
  ...
  maxwell_current                = DOUBLE(1.0e6) * KNIGHT_RELATION__DORS_KLETZING_4(AStructGauss.temp,AstructGauss.N,chartot_kappa_interp/DOUBLE(1.6e-19),R_B) ;, $
  ;; IN_POTBAR=in_potBar, $
  ;; OUT_POTBAR=potBar)
