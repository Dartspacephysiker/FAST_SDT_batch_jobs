...
PRO JOURNAL__20160708__REPRODUCE_ELPHIC_FIG_1__INCLUDE_KAPPA_VALS,SAVE_PNG=save_png,SAVE_PS=save_ps
  ...
  IF NOT KEYWORD_SET(dontShowPlots) THEN BEGIN
     ...
     LOADCT,39
     !p.charsize=1.3
     TPLOT,['dB_East','jtemp','Je','JEei','Ped','POTENTIAL','kappa_fit','el_0','el_pa'], $
