;;09/05/2016 Need some dat
;;Carlson city
PRO JOURNAL__20160905__ORBIT_1789__OUTRIGHT_2DFIT__ION_BEAM
  ...
  save_diff_eFlux_to_file = 'orb_1789--diff_eflux--eeb--output_from_get_losscone_and_eflux_data.sav'
  diff_eFlux_file   = save_diff_eFlux_to_file

  SET_PLOT_DIR,plotDir, $
               /FOR_SDT, $
               /ADD_TODAY, $
               ADD_SUFF='/kappa_fits/Orbit_1789__Carlson_et_al_inverted_V--outright_2d'

  outDir               = '~/software/sdt/batch_jobs/saves_output_etc/'

  fitFile              = GET_TODAY_STRING(/DO_YYYYMMDD_FMT) + '--Carlson_et_al_2001--Kappa_fits_and_Gauss_fits--eeb--fit2d--all_times--150to150--mpfitfun1d--notindividualfit.sav'
