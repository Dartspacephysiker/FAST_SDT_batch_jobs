;;07/08/16
PRO JOURNAL__20160708__ORB_1773__KAPPA_FIT_INVERTED_V_FROM_ELPHIC_ET_AL_1998__CHECK_INTO_BAD_FITS
  ...
  fitFile = '20160708--Elphic_et_al_1998--Kappa_fits_and_Gauss_fits--more_points_above_peak.sav'

  RESTORE,outDir+fitFile

  fitStatus = !NULL
  FOR i=0,N_ELEMENTS(out_kappa_fit_structs)-1 DO fitStatus = [fitStatus,out_kappa_fit_structs[i].fitStatus]
  ...
  ;;Erase them so they don't cause problems
  out_kappa_fit_structs = !NULL
  out_gauss_fit_structs = !NULL
