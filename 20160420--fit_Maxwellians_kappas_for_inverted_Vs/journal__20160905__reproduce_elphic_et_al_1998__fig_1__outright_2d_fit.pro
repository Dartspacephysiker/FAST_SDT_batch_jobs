;;2016/08/06
PRO JOURNAL__20160905__REPRODUCE_ELPHIC_ET_AL_1998__FIG_1__OUTRIGHT_2D_FIT, $
   SAVE_DATA=save_data, $
   SAVE_PNG=save_png, $
   SAVE_PS=save_ps, $
  ...
  STORE_DATA,'kappa_fit',DATA={x:kappa2D.SDT.time,y:aStruct.kappa}
  ...
  kappaStr                       = {time:kappa2D.SDT.time,comp1:aStruct.kappa,ncomp:1}
  ...
  STORE_DATA,'onecheese',DATA={x:kappa2D.SDT.time, $
  ...
  ;;    kappa_current,kappa2D.SDT.time,Astruct, $
