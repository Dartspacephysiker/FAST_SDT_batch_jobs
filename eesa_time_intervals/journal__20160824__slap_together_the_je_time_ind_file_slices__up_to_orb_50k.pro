...
PRO JOURNAL__20160824__SLAP_TOGETHER_THE_JE_TIME_IND_FILE_SLICES__UP_TO_ORB_50K
  ...
  ;;Outfile stuff
  pref                          = 'cleaned_Je__Je_tRanges__and_Je_tRange_inds__0-50000'
  ...
  ;; by_the_thousands_front        = [LINDGEN(nSteps)*1000,49001]
  ;; by_the_thousands_back         = [(LINDGEN(nSteps)+1)*1000-1,50001]

  by_the_thousands_front        = LONG([0,1,2,3,4,5,6,7,9,10,12,13,14,15, $
                                        16,17,18,20,21, $
                                        22,23,24,25,26, $
                                        29,30,31,32, $
                                        34,37,38,39, $
  ...
  by_the_thousands_back         = LONG([0,1,2,3,4,5,6,8,9,11,12,13,14,15, $
                                        16,17,19,20,21, $
                                        22,23,24,25,28, $
                                        29,30,31,33, $
                                        36,37,38,39, $
  ...
  ;; PRINT,ARRAY_EQUAL(je_keys,je_keys2)
  ;; PRINT,ARRAY_EQUAL(je_keys,je_keys3)
END
