...
FUNCTION ASSEMBLE_BRAMBLES_2011_STRUCT,tS_1s, $
  ...
  GET_DATA,'E_ALONG_V_AC',DATA=eAVsc
  GET_DATA,'dB_ac_interp',DATA=dB_perp
  GET_DATA,'pFlux_ac',DATA=pFluxB1s
  ;; GET_DATA,'Je',DATA=Je
  GET_DATA,'pFluxP_ac',DATA=pFluxP
  ;; GET_DATA,'Ji',DATA=Ji
  ...
  PRINT,ARRAY_EQUAL(pFluxP.x,pFluxB1s.x[*,1])
